...
int main(int argc, char** argv)
{
	...
	imov(e, a);
	iadd(e, b);
	tcheckd(e, "8", "iadd 5 + 3", 11);

	imov(e, a);
	iadd(e, c);
	tcheckd(e, "1", "iadd 5 - 4", 11);

	imov(e, a);
	iadd(e, d);
	tcheckd(e, "-1", "iadd 5 - 6", 11);

	imov(e, c);
	iadd(e, d);
	tcheckd(e, "-10", "iadd -4 - 6", 11);

	imov(e, c);
	iadd(e, a);
	tcheckd(e, "1", "iadd -4 + 5", 11);

	imov(e, c);
	iadd(e, b);
	tcheckd(e, "-1", "iadd -4 + 3", 11);

	imov(e, a);
	iadd(e, b);
	iadd(e, c);
	iadd(e, c);
	tcheckd(e, "0", "iadd 0", 11);
	...
	imov(e, a);
	iadd(e, b);
	tcheckd(e, "8000000000000000000000000000000000000", "iadd(5 + 3)*10^36", 55);

	imov(e, a);
	iadd(e, c);
	tcheckd(e, "1000000000000000000000000000000000000", "iadd(5 - 4)*10^36", 55);

	imov(e, a);
	iadd(e, d);
	tcheckd(e, "-1000000000000000000000000000000000000", "iadd(5 - 6)*10^36", 55);

	imov(e, c);
	iadd(e, d);
	tcheckd(e, "-10000000000000000000000000000000000000", "iadd(-4 - 6)*10^36", 55);

	imov(e, c);
	iadd(e, a);
	tcheckd(e, "1000000000000000000000000000000000000", "iadd(-4 + 5)*10^36", 55);

	imov(e, c);
	iadd(e, b);
	tcheckd(e, "-1000000000000000000000000000000000000", "iadd(-4 + 3)*10^36", 55);

	imov(e, a);
	iadd(e, b);
	iadd(e, c);
	iadd(e, c);
	tcheckd(e, "0", "iadd 0", 55);
	...
	imov(e, a);
	iaddk(e, 2 + 1);
	tcheckd(e, "8", "iaddk 5 + 3", 11);

	imov(e, a);
	iaddk(e, -2 - 2);
	tcheckd(e, "1", "iaddk 5 - 4", 11);

	imov(e, a);
	iaddk(e, -3 - 3);
	tcheckd(e, "-1", "iaddk 5 - 6", 11);

	imov(e, c);
	iaddk(e, -2 - 2 - 2);
	tcheckd(e, "-10", "iaddk -4 - 6", 11);

	imov(e, c);
	iaddk(e, 1 + 2 + 2);
	tcheckd(e, "1", "iaddk -4 + 5", 11);

	imov(e, c);
	iaddk(e, 3);
	tcheckd(e, "-1", "iaddk -4 + 3", 11);

	imov(e, a);
	iaddk(e, 3);
	iaddk(e, -4);
	iaddk(e, -4);
	tcheckd(e, "0", "iaddk 0", 11);
	...
	imov(e, a);
	isub(e, b);
	tcheckd(e, "2", "isub 5 - 3", 11);

	imov(e, a);
	isub(e, c);
	tcheckd(e, "9", "isub 5 + 4", 11);

	imov(e, a);
	isub(e, d);
	tcheckd(e, "11", "isub 5 + 6", 11);

	imov(e, c);
	isub(e, d);
	tcheckd(e, "2", "isub -4 + 6", 11);

	imov(e, c);
	isub(e, a);
	tcheckd(e, "-9", "isub -4 - 5", 11);


	imov(e, c);
	isub(e, b);
	tcheckd(e, "-7", "isub -4 - 3", 11);
	...
	imov(e, a);
	isub(e, b);
	tcheckd(e, "2000000000000000000000000000000000000", "isub(5 - 3)*10^36", 55);

	imov(e, a);
	isub(e, c);
	tcheckd(e, "9000000000000000000000000000000000000", "isub(5 + 4)*10^36", 55);

	imov(e, a);
	isub(e, d);
	tcheckd(e, "11000000000000000000000000000000000000", "isub(5 + 6)*10^36", 55);

	imov(e, c);
	isub(e, d);
	tcheckd(e, "2000000000000000000000000000000000000", "isub(-4 + 6)*10^36", 55);

	imov(e, c);
	isub(e, a);
	tcheckd(e, "-9000000000000000000000000000000000000", "isub(-4 - 5)*10^36", 55);

	imov(e, c);
	isub(e, b);
	tcheckd(e, "-7000000000000000000000000000000000000", "isub(-4 - 3)*10^36", 55);
	...
	imov(e, a);
	isubk(e, 3);
	tcheckd(e, "2", "isubk 5 - 3", 11);

	imov(e, a);
	isubk(e, -4);
	tcheckd(e, "9", "isubk 5 + 4", 11);

	imov(e, a);
	isubk(e, -6);
	tcheckd(e, "11", "isubk 5 + 6", 11);

	imov(e, c);
	isubk(e, -6);
	tcheckd(e, "2", "isubk -4 + 6", 11);

	imov(e, c);
	isubk(e, 5);
	tcheckd(e, "-9", "isubk -4 - 5", 11);

	imov(e, c);
	isubk(e, 3);
	tcheckd(e, "-7", "isubk -4 - 3", 11);
	...
	isubk(e, -12 + 6);
	isubk(e, -6);
	tcheckd(e, "0", "isubk 0", 51);

	tprint("Check imovk, iaddk, isubk, imov, iadd, isub again\n");

	imovk(a, 999999999);
	tcheckd(a, "999999999", "imovk", 1);

	imovk(b, 222222222);
	tcheckd(b, "222222222", "imovk", 2);
	...
	imovk(a, 0);
	imovk(b, isgn(a));
	tcheckd(b, "0", "isgn 0", 1);
	ineg(a);
	tcheckd(a, "0", "ineg 0", 2);
	imovk(b, isgn(a));
	tcheckd(b, "0", "isgn 0", 3);

	imovk(a, 230000);
	imovk(b, isgn(a));
	tcheckd(b, "1", "isgn 1", 4);

	ineg(a);
	tcheckd(a, "-230000", "ineg -230000", 5);

	imovk(b, isgn(a));
	tcheckd(b, "-1", "isgn -1", 6);

	ineg(a);
	tcheckd(a, "230000", "ineg 230000", 7);
	...
	imovk(a, 0);
	imovk(b, iwd0(a));
	tcheckd(b, "0", "iwd0 0", 1);
	imovk(b, iodd(a));
	tcheckd(b, "0", "iodd 0", 1);
	imovk(b, ieven(a));
	tcheckd(b, "1", "ieven 0", 1);
	imovk(a, 230000);

	imovk(b, iwd0(a));
	tcheckd(b, "230000", "iwd0 230000", 2);
	imovk(b, iodd(a));
	tcheckd(b, "0", "iodd 230000", 2);
	imovk(b, ieven(a));
	tcheckd(b, "1", "ieven 230000", 2);
	imovk(a, -230000);

	imovk(b, iwd0(a));
	tcheckd(b, "230000", "iwd0 -230000", 3);
	imovk(b, iodd(a));
	tcheckd(b, "0", "iodd -230000", 3);
	imovk(b, ieven(a));
	tcheckd(b, "1", "ieven -230000", 3);
	imovd(a, "3333333333333333333333333333333333333");

	imovk(b, iwd0(a));
	tcheckd(b, "1431655765", "iwd0 333...333", 4);
	imovk(b, iodd(a));
	tcheckd(b, "1", "iodd 111...111", 4);
	imovk(b, ieven(a));
	tcheckd(b, "0", "ieven 111...111", 4);
	imovd(a, "-3333333333333333333333333333333333333");

	imovk(b, iwd0(a));
	tcheckd(b, "1431655765", "iwd0 -333...333", 5);
	imovk(b, iodd(a));
	tcheckd(b, "1", "iodd -111...111", 5);
	imovk(b, ieven(a));
	tcheckd(b, "0", "ieven -111...111", 5);

	tprint("Check ilen, ibit\n");

	imovk(a, 0);
	imovk(b, ilen(a));
	tcheckd(b, "0", "ilen 0", 1);
	imovk(b, ibit(a, 0));
	tcheckd(b, "0", "ibit 0, 0", 1);
	imovk(b, ibit(a, 1));
	tcheckd(b, "0", "ibit 0, 1", 1);
	imovk(b, ibit(a, 31));
	tcheckd(b, "0", "ibit 0, 31", 1);
	imovk(b, ibit(a, 32));
	tcheckd(b, "0", "ibit 0, 32", 1);

	ttbit("0");
	imovk(a, 2300001);
	imovk(b, ilen(a));
	tcheckd(b, "22", "ilen 2300001", 1);
	imovk(b, ibit(a, 0));
	tcheckd(b, "1", "ibit 2300001, 0", 1);
	imovk(b, ibit(a, 1));
	tcheckd(b, "0", "ibit 2300001, 1", 1);
	imovk(b, ibit(a, 21));
	tcheckd(b, "1", "ibit 2300001, 21", 1);
	imovk(b, ibit(a, 22));
	tcheckd(b, "0", "ibit 2300001, 22", 1);
	imovk(b, ibit(a, 500));
	tcheckd(b, "0", "ibit 2300001, 500", 1);
	ttbit("2300001");
	imovd(a, "3333333333333333333333333333333333333");
	imovk(b, ilen(a));
	tcheckd(b, "122", "ilen 333...333", 1);
	imovk(b, ibit(a, 0));
	tcheckd(b, "1", "ibit 333...333, 0", 1);
	imovk(b, ibit(a, 1));
	tcheckd(b, "0", "ibit 333...333, 1", 1);
	imovk(b, ibit(a, 121));
	tcheckd(b, "1", "ibit 333...333, 21", 1);
	imovk(b, ibit(a, 122));
	tcheckd(b, "0", "ibit 333...333, 22", 1);
	imovk(b, ibit(a, 500));
	tcheckd(b, "0", "ibit 333...333, 500", 1);
	...
	imovk(h, -4);
	imovk(x, icmp(a, g));
	tcheckd(x, "0", "icmp 5 = 5", 11);
	imovk(x, icmp(c, h));
	tcheckd(x, "0", "icmp -4 = -4", 11);
	imovk(x, icmp(a, b));
	tcheckd(x, "1", "icmp 5 > 3", 11);
	imovk(x, icmp(a, b));
	tcheckd(x, "1", "icmp 5 > 3", 11);
	imovk(x, icmp(a, c));
	tcheckd(x, "1", "icmp 5 > -4", 11);
	imovk(x, icmp(a, d));
	tcheckd(x, "1", "icmp 5 > -6", 11);
	imovk(x, icmp(c, d));
	tcheckd(x, "1", "icmp -4 > -6", 11);
	imovk(x, icmp(c, a));
	tcheckd(x, "-1", "icmp -4 < 5", 11);
	imovk(x, icmp(c, b));
	tcheckd(x, "-1", "icmp -4 < 3", 11);
	imovk(x, icmp(a, e));
	tcheckd(x, "1", "icmp 5 > 0", 11);
	imovk(x, icmp(a, f));
	tcheckd(x, "1", "icmp 5 > -0", 11);
	imovk(x, icmp(c, e));
	tcheckd(x, "-1", "icmp -4 < 0", 11);
	imovk(x, icmp(c, f));
	tcheckd(x, "-1", "icmp -4 < -0", 11);
	imovk(x, icmp(e, a));
	tcheckd(x, "-1", "icmp 0 < 5", 11);
	imovk(x, icmp(f, a));
	tcheckd(x, "-1", "icmp -0 < 5", 11);
	imovk(x, icmp(e, c));
	tcheckd(x, "1", "icmp 0 > -4", 11);
	imovk(x, icmp(f, c));
	tcheckd(x, "1", "icmp -0 > -4", 11);
	imovk(x, icmp(e, e));
	tcheckd(x, "0", "icmp 0 = 0", 11);
	imovk(x, icmp(e, f));
	tcheckd(x, "0", "icmp 0 = -0", 11);
	imovk(x, icmp(f, e));
	tcheckd(x, "0", "icmp -0 = 0", 11);
	...
	uextend(b, 21);
	xmovk(&b->value[1], 0, 20);
	uextend(d, 21);
	xmovk(&d->value[1], 0, 20);
	uextend(f, 21);
	xmovk(&f->value[1], 0, 20);
	uextend(g, 21);
	xmovk(&g->value[1], 0, 20);
	uextend(h, 21);
	xmovk(&h->value[1], 0, 20);

	imovk(x, icmp(a, g));
	tcheckd(x, "0", "icmp 5 = 5", 15);
	imovk(x, icmp(c, h));
	tcheckd(x, "0", "icmp -4 = -4", 15);
	imovk(x, icmp(a, b));
	tcheckd(x, "1", "icmp 5 > 3", 15);
	imovk(x, icmp(a, d));
	tcheckd(x, "1", "icmp 5 > -6", 15);
	imovk(x, icmp(c, b));
	tcheckd(x, "-1", "icmp -4 < 3", 15);
	imovk(x, icmp(c, d));
	tcheckd(x, "1", "icmp -4 > -6", 15);
	imovk(x, icmp(b, a));
	tcheckd(x, "-1", "icmp 3 < 5", 51);
	imovk(x, icmp(d, b));
	tcheckd(x, "-1", "icmp -6 < 5", 51);
	imovk(x, icmp(b, c));
	tcheckd(x, "1", "icmp 3 > -4", 51);
	imovk(x, icmp(d, c));
	tcheckd(x, "-1", "icmp -6 < 4", 51);
	imovk(x, icmp(a, e));
	tcheckd(x, "1", "icmp 5 > 0", 11);
	imovk(x, icmp(a, f));
	tcheckd(x, "1", "icmp 5 > -0", 15);
	imovk(x, icmp(c, e));
	tcheckd(x, "-1", "icmp -4 < 0", 11);
	imovk(x, icmp(c, f));
	tcheckd(x, "-1", "icmp -4 < -0", 15);
	imovk(x, icmp(e, a));
	tcheckd(x, "-1", "icmp 0 < 5", 11);
	imovk(x, icmp(f, a));
	tcheckd(x, "-1", "icmp -0 < 5", 51);
	imovk(x, icmp(e, c));
	tcheckd(x, "1", "icmp 0 > -4", 11);
	imovk(x, icmp(f, c));
	tcheckd(x, "1", "icmp -0 > -4", 51);
	imovk(x, icmp(e, e));
	tcheckd(x, "0", "icmp 0 = 0", 11);
	imovk(x, icmp(e, f));
	tcheckd(x, "0", "icmp 0 = -0", 15);
	imovk(x, icmp(f, e));
	tcheckd(x, "0", "icmp -0 = 0", 51);
	imovk(x, icmp(f, f));
	tcheckd(x, "0", "icmp -0 = -0", 55);

	/* All large */
	uextend(a, 21);
	xmovk(&a->value[1], 0, 20);
	uextend(c, 21);
	xmovk(&c->value[1], 0, 20);
	uextend(e, 21);
	xmovk(&e->value[1], 0, 20);

	imovk(x, icmp(a, g));
	tcheckd(x, "0", "icmp 5 = 5", 55);
	imovk(x, icmp(c, h));
	tcheckd(x, "0", "icmp -4 = -4", 55);
	imovk(x, icmp(a, b));
	tcheckd(x, "1", "icmp 5 > 3", 55);
	imovk(x, icmp(a, c));
	tcheckd(x, "1", "icmp 5 > -4", 55);
	imovk(x, icmp(a, d));
	tcheckd(x, "1", "icmp 5 > -6", 55);
	imovk(x, icmp(c, d));
	tcheckd(x, "1", "icmp -4 > -6", 55);
	imovk(x, icmp(c, a));
	tcheckd(x, "-1", "icmp -4 < 5", 55);
	imovk(x, icmp(c, b));
	tcheckd(x, "-1", "icmp -4 < 3", 55);
	imovk(x, icmp(a, e));
	tcheckd(x, "1", "icmp 5 > 0", 55);
	imovk(x, icmp(a, f));
	tcheckd(x, "1", "icmp 5 > -0", 55);
	imovk(x, icmp(c, e));
	tcheckd(x, "-1", "icmp -4 < 0", 55);
	imovk(x, icmp(c, f));
	tcheckd(x, "-1", "icmp -4 < -0", 55);
	imovk(x, icmp(e, a));
	tcheckd(x, "-1", "icmp 0 < 5", 55);
	imovk(x, icmp(f, a));
	tcheckd(x, "-1", "icmp -0 < 5", 55);
	imovk(x, icmp(e, c));
	tcheckd(x, "1", "icmp 0 > -4", 55);
	imovk(x, icmp(f, c));
	tcheckd(x, "1", "icmp -0 > -4", 55);
	imovk(x, icmp(e, e));
	tcheckd(x, "0", "icmp 0 = 0", 55);
	...
	imovk(x, icmpk(a, 5));
	tcheckd(x, "0", "icmpk 5 = 5", 11);
	imovk(x, icmpk(c, -4));
	tcheckd(x, "0", "icmpk -4 = -4", 11);
	imovk(x, icmpk(a, 3));
	tcheckd(x, "1", "icmpk 5 > 3", 11);
	imovk(x, icmpk(a, 3));
	tcheckd(x, "1", "icmpk 5 > 3", 11);
	imovk(x, icmpk(a, -4));
	tcheckd(x, "1", "icmpk 5 > -4", 11);
	imovk(x, icmpk(a, -6));
	tcheckd(x, "1", "icmpk 5 > -6", 11);
	imovk(x, icmpk(c, -6));
	tcheckd(x, "1", "icmpk -4 > -6", 11);
	imovk(x, icmpk(c, 5));
	tcheckd(x, "-1", "icmpk -4 < 5", 11);
	imovk(x, icmpk(c, 3));
	tcheckd(x, "-1", "icmpk -4 < 3", 11);
	imovk(x, icmpk(a, 0));
	tcheckd(x, "1", "icmpk 5 > 0", 11);
	imovk(x, icmpk(a, -0));
	tcheckd(x, "1", "icmpk 5 > -0", 11);
	imovk(x, icmpk(c, 0));
	tcheckd(x, "-1", "icmpk -4 < 0", 11);
	imovk(x, icmpk(c, -0));
	tcheckd(x, "-1", "icmpk -4 < -0", 11);
	imovk(x, icmpk(e, 5));
	tcheckd(x, "-1", "icmpk 0 < 5", 11);
	imovk(x, icmpk(f, 5));
	tcheckd(x, "-1", "icmpk -0 < 5", 11);
	imovk(x, icmpk(e, -4));
	tcheckd(x, "1", "icmpk 0 > -4", 11);
	imovk(x, icmpk(f, -4));
	tcheckd(x, "1", "icmpk -0 > -4", 11);
	imovk(x, icmpk(e, 0));
	tcheckd(x, "0", "icmpk 0 = 0", 11);
	imovk(x, icmpk(e, -0));
	tcheckd(x, "0", "icmpk 0 = -0", 11);
	imovk(x, icmpk(f, 0));
	tcheckd(x, "0", "icmpk -0 = 0", 11);
	...
	imovk(a, 100000);
	isqu(a);
	tcheckd(a, "10000000000", "isqu+", 1);
	imovk(a, -100000);
	isqu(a);
	tcheckd(a, "10000000000", "isqu-", 2);

	imovk(a, 100000);
	imovk(b, 23);
	imul(a, b);
	tcheckd(a, "2300000", "imul++", 1);
	imovk(a, 100000);
	imovk(b, -23);
	imul(a, b);
	tcheckd(a, "-2300000", "imul+-", 2);
	imovk(a, -100000);
	imovk(b, 23);
	imul(a, b);
	tcheckd(a, "-2300000", "imul-+", 3);
	imovk(a, -100000);
	imovk(b, -23);
	imul(a, b);
	tcheckd(a, "2300000", "imul--", 4);
	imovk(a, 100000);
	imulk(a, 23);
	tcheckd(a, "2300000", "imulk++", 1);
	imovk(a, 100000);
	imulk(a, -23);
	tcheckd(a, "-2300000", "imulk+-", 2);
	imovk(a, -100000);
	imulk(a, 23);
	tcheckd(a, "-2300000", "imulk-+", 3);
	imovk(a, -100000);
	imulk(a, -23);
	tcheckd(a, "2300000", "imulk--", 4);
	imovk(a, 100000);
	idivk(a, 100);
	imovk(b, kres);
	tcheckd(a, "1000", "idivk 0+", 1);
	tcheckd(b, "0", "kres 0+", 1);
	imovk(a, -100000);
	idivk(a, 100);
	imovk(b, kres);
	tcheckd(a, "-1000", "idivk 0-", 2);
	tcheckd(b, "0", "kres 0-", 2);
	imovk(a, 100000);
	idivk(a, 77);
	imovk(b, kres);
	tcheckd(a, "1298", "idivk +", 3);
	tcheckd(b, "54", "kres +", 3);
	imovk(a, -100000);
	idivk(a, 77);
	imovk(b, kres);
	tcheckd(a, "-1298", "idivk +", 4);
	tcheckd(b, "-54", "kres +", 4);
	imovk(a, 100000);
	imodk(a, 100);
...
/* check idiv and imod */
{
	...
	for (i = 0; i <= to; i++)
	{
		...
		imov(z, b);
		imod(x, z);
		tcheckr(x, c, "imod A+", i);
		idiv(y, z);
		tcheckr(y, d, "idivq A+", i);
		tcheckr(res, c, "idivr A+", i);
		imov(x, a);
		ineg(x);
		imov(y, x);
		imod(x, z);
		tcheckr(x, g, "imod A-", i);
		idiv(y, z);
		tcheckr(y, f, "idivq A-", i);
		tcheckr(res, e, "idivr A-", i);
		imulk(a, mult);
		imulk(b, mult);
		imulk(c, mult);
		imulk(e, mult);
...
/* check "2k" functions: usep2k, imul2k, idiv2k, imod2k */
{
	...
	imov(a, h);
	usep2k(a, b, i);
	tcheckr(a, e, "usep2k m", ki);
	tcheckr(b, f, "usep2k q", ki);
	imov(a, h);
	imul2k(a, i);
